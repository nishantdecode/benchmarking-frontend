...
export function SelectCategoryIncome({ search, categories, height }) {
  const [open, setOpen] = useState(false);
  const router = useRouter();
  const searchParams = useSearchParams();
  const category = searchParams.get("incomeStatmentCategory");
                ...
                >
                  <button
                    ...
                    onClick={() => {
                      setOpen(false);
                      navigate({
                        paramNameToUpdate: "incomeStatmentCategory",
                        newValue: item.name,
                      });
                    }}
                  >
